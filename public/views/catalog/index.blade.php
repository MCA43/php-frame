        ...
        <div class="col-xl-8 col-lg-10 col-12">
            <div class="team-details position-relative">
                ...
                <div class="team-details-about">
                    <h2 class="team-details-about-title tp-el-bio-title"> {{ $about['title'] ?? "PHP Frame Hakkında" }} </h2>
                ...
                <div class="team-details-exprience">
                    <h2 class="team-details-exprience-title tp-el-bio-title">{{ $feature['title'] ?? 'Eklenen Özellikler' }}</h2>
                    <ul>
                        @if(isset($feature['list']) && is_array($feature['list']) && count($feature['list']) > 0)
                            @foreach($feature['list'] as $li)
                                <li class="tp-el-bio-list"> {!! $li !!} </li>
                            @endforeach
                        @endif
                    </ul>
                </div>
