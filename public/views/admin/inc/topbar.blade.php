<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top purple">
    ...
    <div class="navbar-header">
        ...
        <a href="{{ base_url('panel') }}" class="navbar-brand">
            <span class="brand-icon"><i class="fa fa-gg"></i></span>
            <span class="brand-name"> PHP FRAME </span>
        </a>
    </div>
    ...
    <div class="navbar-container container-fluid">
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
                ...
                <li class="nav-item dropdown hidden-float">
                    <a href="{{ base_url('') }}" aria-expanded="false" target="_blank">
                        <i class="zmdi zmdi-hc-lg zmdi-globe"></i>
                    </a>
                </li>
